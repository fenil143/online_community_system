...
export default function Product(props) {
  ...
  return (
    <div class="w-full font-poppins md:w-full max-w-md mx-auto hover:scale-105 transition-transform duration-500 bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl mt-4">
   <div class="md:flex ">
    <div class="md:shrink-0 flex flex-col items-center md:items-start   justify-center">
      <img class="h-48 w-full object-cover md:h-auto md:w-48" src="https://cdn1.iconfinder.com/data/icons/website-internet/48/website_-_male_user-512.png" alt="User Image" />
      <div class="flex justify-center mt-2 md:mt-0">
          <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" class="flex p-px pl-2 pb-3 items-center hover:scale-125 transition-transform mr-2">
              <i class="bi bi-linkedin text-xl text-red-500"></i>
              <span class="hidden md:inline-block ml-1">LinkedIn</span>
          </a>
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" class="flex items-center pl-2 pb-3 hover:scale-125 transition-transform">
      ...
      <div class="p-8">
        ...
        <div className="flex items-center mb-2">
             ...
             <div className="flex items-center mb-2">
             <span className="text-gray-700 font-medium">Working Location :</span><h6 className="text-success ml-2">{dummy.working_location == undefined? "Free shipping" : dummy.working_location}</h6>
